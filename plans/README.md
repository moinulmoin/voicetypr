...
| 030  | Windows crash dependencies — stale monitors + tray device-change paint loop | `2026-07-14` (this session) | NEEDS-SMOKE — `tao 0.34.6` + `tray-icon 0.21.2`; local quality gate and release clippy green; Windows CI/build + signed Beta 4 device-change/monitor-transition smoke remain |
