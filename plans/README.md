...
| 060  | Beta10 release remediation — migrated silent failures plus reviewed release fixes | P0 | L | 031 (pivot), 019 seam | CODE COMPLETE / NEEDS-SMOKE — local branch `fix/060-beta10-readiness`; 684 frontend and 1,509 Rust workspace tests pass (16 Rust ignored), typecheck/lint/build/Clippy green. Final integrated reviews cleared after corrections. Not pushed, merged, or released; packaged 060-S1–S10 and existing release smoke remain unchecked. See `060-beta10-readiness.md`. |
