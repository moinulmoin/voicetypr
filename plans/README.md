...
| 059  | No-speech gate — pre-engine reject on strong absence evidence, all STT paths; kills hallucinate-and-polish | P0 | S | — | IN PROGRESS — claimed Main 2026-08-21; code complete on \`feat/no-speech-gate\`: classifier extended past exact-zero with floors calibrated from 76-attempt dev-log corpus (silence rms ≤0.00071 vs quietest speech 0.0084), gate fires pre-engine on every route, 1383/1383 + clippy green; live dev-app smoke passed 2026-08-22 (skipped_no_speech + skipped_no_input outcomes observed) |
